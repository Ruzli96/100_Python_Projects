...
split_number = int(input("How many people would you like this bill to be split among?\n"))
tip = int(input("What is your tip percentage? 10, 12, or 15?\n"))
amount_per = total_bill/split_number
tip_amount_per = (amount_per*(tip/100)) + amount_per
print(f'Each person should pay\n${"{:.2f}".format(round(tip_amount_per, 2))}')